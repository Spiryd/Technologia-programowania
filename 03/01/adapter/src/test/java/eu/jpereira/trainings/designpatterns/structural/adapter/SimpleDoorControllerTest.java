...
public class SimpleDoorControllerTest {
	...
	@Test
	public void testShouldOpenDoor() throws DoorNotManagedException, IncorrectDoorCodeException, CannotChangeStateOfLockedDoor {
		// Create a simple dummy door, conforming the Interface Door
	...
	@Test
	public void testShouldCloseDoor() throws DoorNotManagedException, IncorrectDoorCodeException, CannotChangeStateOfLockedDoor {
		Door mockedDoor = createMockedDoor();
		DoorController controller = createDoorControllerUnderTest();
