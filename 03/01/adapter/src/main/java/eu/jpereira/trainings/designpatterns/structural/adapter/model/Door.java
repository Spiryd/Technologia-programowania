...
public interface Door {
	 ...
	 */
	void open(String code) throws IncorrectDoorCodeException, CannotChangeStateOfLockedDoor;

	/**
	 * Attempt to close the door
	 */
	void close() throws CannotChangeStateOfLockedDoor;
	...
	void changeCode(String oldCode, String newCode, String newCodeConfirmation)
			throws IncorrectDoorCodeException, CodeMismatchException, CannotChangeCodeForUnlockedDoor;
